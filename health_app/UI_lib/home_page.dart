  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.notifications_outlined, color: Colors.white, size:35),
            onPressed: () {
                          ...
                          children: [
                            ...
                            Container(
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(
                                    color: Colors.black.withOpacity(0.05), // ✅ same as your cards
                                    blurRadius: 10,
                                    offset: Offset(0, 2),                  // ✅ slightly lighter than other boxes on this page
                                  ),
                                ],
                              ),
                              child: OutlinedButton(
                                ...
                                style: OutlinedButton.styleFrom(
                                  foregroundColor: ThemeProvider.getAuthTextColor(context),
                                  side: BorderSide.none,
                                  shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(30),
                                  ),
                                  padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 14), // padding optional
                                ),
